...
export const NavBar: FC<NavBarTypes> = ({ onSignInClick, onFeedbackClick, onNotificationClick, onHelpCenterClick, showHelpCenterNotificationMarker, showNotificationMarker }) => {
        ...
        <div className={styles.leftWrapper}>
          <div className={styles.pageIcon}>
            <div className={styles.pmmIconHolder}>
              <img alt="percona-logo" className={styles.pmmIcon} src="/graph/public/plugins/pmm-app/img/percona-logo.svg" />
            </div>
          </div>
