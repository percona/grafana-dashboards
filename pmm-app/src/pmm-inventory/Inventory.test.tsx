...
describe('Inventory tables', () => {
  it('Agents table renders correct with right data', () => {
    ...
    const root = mount(
      <Table
        data={InventoryDataService.generateAgentsStructure(response as any)}
  ...
  it('Services table renders correct with right data', () => {
    ...
    const root = mount(
      <Table
        data={InventoryDataService.generateServicesStructure(response as any)}
  ...
  it('Nodes table renders correct with right data', () => {
    ...
    const root = mount(
      <Table
        data={InventoryDataService.generateNodesStructure(response as any)}
