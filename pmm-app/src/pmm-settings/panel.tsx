    ...
    return <>
        <Collapse bordered={false} defaultActiveKey={['1']} onChange={callback} style={customPanelStyle}>
            <Panel header="General" key="1">
               <p style={textStyle}> Metrics resolution: <Slider marks={marks} max={2} step={null} defaultValue={2} /></p>
            </Panel>
            <Panel header="Advanced settings" key="2" style={customPanelStyle}>
                ...
                <p style={textStyle}> Call home: <Switch defaultChecked onChange={() =>{}} /></p>
                <p style={textStyle}> Check for updates: <Switch defaultChecked onChange={() =>{}} />         <Tooltip placement="topLeft" title={'Some text to copy'} style={{backgroundColor: 'deepskyblue'}}>
                    <Icon type="question-circle" style={{ marginLeft: "5px" }} />
                </Tooltip></p>
                <Divider></Divider>
                <p style={textStyle}> Orchestrator: <Switch defaultChecked onChange={() =>{}} /></p>
