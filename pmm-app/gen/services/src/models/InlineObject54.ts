...
export function InlineObject54FromJSON(json: any): InlineObject54 {
    return InlineObject54FromJSONTyped(json, false);
}

export function InlineObject54FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineObject54 {
...
export function InlineObject54ToJSON(value?: InlineObject54 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
