...
export function InlineObject50FromJSON(json: any): InlineObject50 {
    return InlineObject50FromJSONTyped(json, false);
}

export function InlineObject50FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineObject50 {
...
export function InlineObject50ToJSON(value?: InlineObject50 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
