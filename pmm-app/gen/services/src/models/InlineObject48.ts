...
export function InlineObject48FromJSON(json: any): InlineObject48 {
    return InlineObject48FromJSONTyped(json, false);
}

export function InlineObject48FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineObject48 {
...
export function InlineObject48ToJSON(value?: InlineObject48 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
