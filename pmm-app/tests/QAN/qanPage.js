...
module.exports = {
  ...
  fields: {
    ...
    countOfItems: "//div[@class='query-analytics-data']/div/div[2]/div/div[1]/div/div[2]/div/span",
    resetAll: 'button#reset-all-filters',
    newQANSpinnerLocator: "//i[@class='fa fa-spinner fa-spin spinner ant-spin-dot']",
    showSelected: "//div[@class='overview-filters']/div/div/form/div/div[1]/button[1]",
