  ...
  fillRemoteFields(serviceName) {
    ...
    switch (serviceName) {
      ...
      case this.services.mongodb:
        I.fillField(this.fields.hostName, process.env.REMOTE_MONGODB_HOST || '34.200.242.226');
        I.fillField(this.fields.userName, process.env.REMOTE_MONGODB_USER || 'admin');
        I.fillField(this.fields.password, process.env.REMOTE_MONGODB_PASSWORD || '4Ju4nuTbLL};,4:F');
        I.fillField(this.fields.serviceName, serviceName);
