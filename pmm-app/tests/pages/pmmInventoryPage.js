...
module.exports = {
  ...
  fields: {
    ...
    agentsLink: '//div[@class="inventory-wrapper"]//li[contains(text(),"Agents")]',
    nodesLink: '//div[@class="inventory-wrapper"]//li[contains(text(),"Nodes")]',
    pmmServicesSelector: '//div[@class="inventory-wrapper"]//li[contains(text(),"Services")]',
