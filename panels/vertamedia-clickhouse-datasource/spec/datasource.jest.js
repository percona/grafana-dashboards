...
describe("clickhouse sql series:", function () {
    describe("SELECT $timeseries response WHERE $adhoc = 1", function () {
        var response = {
            "meta": [
                {
                    "name": "t"
    ...
    describe("SELECT $columns response", function () {
        ...
        var timeSeries = sqlSeries.toTimeSeries();
        it("expects four results", function () {
    ...
    describe("When performing ad-hoc query", function () {
        var response = {
            "meta": [
                {
                    "name": "database",
        ...
        // @ts-ignore
        var rp = new ResponseParser(_this.$q);
        var adhocCtrl = new AdhocCtrl({ defaultDatabase: "default" });
